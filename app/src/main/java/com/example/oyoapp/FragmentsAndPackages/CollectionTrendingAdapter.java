...
public class CollectionTrendingAdapter extends RecyclerView.Adapter<CollectionTrendingAdapter.Vhadapter> {
ArrayList<CollectionTrendingmodel>slist;

    public CollectionTrendingAdapter(ArrayList<CollectionTrendingmodel> slist) {
        this.slist = slist;
    }
    ...
    public Vhadapter onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=  LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.collectiontrendingrecycleritem,viewGroup,false);

        return new CollectionTrendingAdapter.Vhadapter(view);
    }
